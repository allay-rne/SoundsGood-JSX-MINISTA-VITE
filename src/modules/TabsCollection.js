...
class Tabs extends BaseComponent {
  ...
  constructor(rootElement) {
    ...
    this.contentsElements = [...this.rootElement.querySelectorAll(this.selectors.content)]
  ...
  updateUI() {
    ...
    this.contentsElements.forEach((contentElements, index) =>{
      const isActive = index === activeTabIndex
  ...
  onKeyDown = (event) => {
    ...
    const isTabsContentFocused = this.contentsElements
  ...
  bindObservers = () => {
    const resizeObservers = new ResizeObserver(this.onResize)

    resizeObservers.observe(this.navigationElement)
  }
}
